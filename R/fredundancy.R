...
#' @param abundance A vector of abundances representing each species in the community. The vector is checked to ensure the abundances sum to 1. Note that the vector can also have zero values,
#'                   although absolute continuity must hold (from a non abundant species that species cannot have any function).
